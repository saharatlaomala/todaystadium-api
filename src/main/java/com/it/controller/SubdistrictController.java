...
public class SubdistrictController {
	...
	public ResponseEntity<Object> getSubdistrictAll() {
		return ResponseEntity.ok(subdistrictService.findSubdistrictAll());
	...
	@PutMapping("/{sdtId}")
	public ResponseEntity<Object> updateSubdistrict(
			@PathVariable(name = "sdtId") Integer sdtId,
			@RequestBody SubdistrictDto subdistrictDto) {
		return ResponseEntity.ok(subdistrictService.updateSubdistrictBySdtId(sdtId, subdistrictDto));
	}
